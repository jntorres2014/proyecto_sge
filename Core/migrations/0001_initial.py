# Generated by Django 4.2.8 on 2024-03-07 13:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('codigoPostal', models.CharField(error_messages={'blank': 'El Codigo Postal  es obligatorio', 'max_length': 'El Codigo Postal puede tener a lo sumo 4 caracteres', 'unique': 'El Codigo Postal ingresado ya existe'}, help_text='cp', max_length=4)),
                ('nombre', models.CharField(error_messages={'blank': 'El nombre es obligatorio', 'max_length': 'El nombre puede tener a lo sumo 70 caracteres'}, help_text='Trelew ', max_length=70, validators=[django.core.validators.RegexValidator(regex='^[0-9a-zA-Z-_ .]{3,100}$')])),
            ],
        ),
        migrations.CreateModel(
            name='Persona',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.ForeignKey(default='Docente', on_delete=django.db.models.deletion.CASCADE, to='Core.rol')),
            ],
            bases=('Core.persona',),
        ),
        migrations.CreateModel(
