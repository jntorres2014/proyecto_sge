# Generated by Django 4.2.8 on 2024-02-06 20:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Direccion', models.CharField(error_messages={'blank': 'El dni es obligatorio', 'max_length': 'El dni puede tener a lo sumo 11 caracteres', 'unique': 'El dni ingresado ya existe'}, help_text='Direccion', max_length=100)),
                ...
                ('Telefono', models.CharField(blank=True, error_messages={'max_length': 'El telefono puede tener a lo sumo 10 caracteres'}, help_text='Telefono ', max_length=10, null=True, validators=[django.core.validators.RegexValidator(regex='^[0-9]{1,12}$')])),
